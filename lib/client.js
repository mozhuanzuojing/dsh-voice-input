...
(() => {
  ...
  function findComposer() {
    ...
    if (card) {
      const editable = Array.from(card.querySelectorAll('[contenteditable="true"], [contenteditable=""]')).find(
    ...
    const anyEditable = Array.from(document.querySelectorAll('[contenteditable="true"], [contenteditable=""]')).find(
      (el) => el.offsetParent !== null
    );
